...
- Keep browser NFC lifecycle coordination behind the shared per-entry session context; keep ledger parsing and write planning behind `website/src/utils/wandLedgerCodec.ts`, with `useNfc` providing the thin website integration.
